...
- (instancetype)initWithSettings:(NSDictionary *)videoSettings;
{
    ...
    if (self) {
        ...
        self.writerInput.transform = CGAffineTransformMakeRotation(DEGREES_TO_RADIANS(90));
//      self.writerInput.transform = CGAffineTransformMakeScale(4, 4);
        ...
        _frameTime = CMTimeMake(1, self.framesPerSecond);
    }
    return self;
}
